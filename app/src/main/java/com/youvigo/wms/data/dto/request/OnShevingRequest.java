...
public class OnShevingRequest {
	...
	@SerializedName("ITEM")
	private OnShevingDetails details;
	...
	public OnShevingDetails getDetails() {
		return details;
	}

	public void setDetails(OnShevingDetails details) {
	...
	public OnShevingRequest(ControlInfo controlInfo, OnShevingDetails details) {
		this.controlInfo = controlInfo;
		this.details = details;
	}
}
