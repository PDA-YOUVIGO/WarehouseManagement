...
public class InternalOrderResponseDetails {
	...
	public InternalOrderResponseDetails(List<InternalOrder> internalOrders, SapResponseMessage responseMessage) {
	...
	public InternalOrderResponseDetails() {
	}
}
